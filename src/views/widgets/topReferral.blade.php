...
<div class="dashboard-item">
    ...
    <div class="dashboard-item__inner">
        <div class="dashboard-item__pic">
            <div class="dashboard-chart__wrap">
                <div class="dashboard-chart__pie-value"></div>
                <div class="dashboard-chart jsChartTypesSourceTraffic"></div>
            </div>
        </div>
        <div class="dashboard-item__title"></div>
        <div class="dashboard-item__desc">Топ источники<br>трафика/переходов</div>
